...
export default class Level5 extends GameLevel {
    ...
    startScene(): void {
        ...
        this.addStation('oven', new Vec2(32.8,9.5), {indicatorKey: "foodIndicator", foodToCook: Foods.FRIES});
        this.addStorage('fridge', new Vec2(34.3,9), {indicatorKey: "foodIndicator", ingredient: Ingredients.SYRUP});
        this.addStorage('fridge', new Vec2(35.6,9), {indicatorKey: "foodIndicator", ingredient: Ingredients.FLOUR_MIX});
